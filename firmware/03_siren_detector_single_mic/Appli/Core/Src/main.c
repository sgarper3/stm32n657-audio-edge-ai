...
int main(void)
{
  ...
  printf("\r\n\r\n========================================\r\n");
  printf("BOOT: UART READY - Neural-ART INT8 Resnet_siren_8\r\n");
  printf("========================================\r\n");
  fflush(stdout);
  ...
  printf("\r\nMODE: HEADER INT8 TEST - Resnet_siren_8\r\n");
  fflush(stdout);

  printf("\r\nMULTI INT8 TEST START\r\n");
  fflush(stdout);

  for (int sample_id = 0; sample_id < NUM_TEST_INPUTS; sample_id++)
  {
      printf("\r\n========================================\r\n");
      printf("MULTI INT8 TEST sample_id=%d/%d\r\n",
             sample_id,
             NUM_TEST_INPUTS - 1);
      ...
      printf("MULTI INT8 TEST sample_id=%d DONE\r\n", sample_id);
      fflush(stdout);

      HAL_Delay(200);
  }

  printf("\r\nMULTI INT8 TEST DONE\r\n");
  fflush(stdout);

  #elif AI_INPUT_SOURCE == AI_INPUT_SOURCE_MIC

  printf("\r\nMODE: MICROPHONE REAL AUDIO - Resnet_siren_8\r\n");
  fflush(stdout);
