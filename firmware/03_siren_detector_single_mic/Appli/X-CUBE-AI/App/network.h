...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "miniresnetv1_s1_64x50_siren_final_int8"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (3200)

/************************** OUTPUTS *******************************************/
#define LL_ATON_DEFAULT_OUT_NUM        (1)    // Total number of output buffers
// Output buffer 1 -- Quantize_43_out_0
